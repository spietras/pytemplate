...
see `pytemplate/README.md`
or [docs](https://spietras.github.io/pytemplate).
...
into `pytemplate` directory and run:
...
write the tests and put them in `pytemplate/tests`.
...
Docs should be placed in `pytemplate/docs/docs`. They
are pretty straightforward to write.

To build the docs,
`cd` into `pytemplate/docs` and run:
